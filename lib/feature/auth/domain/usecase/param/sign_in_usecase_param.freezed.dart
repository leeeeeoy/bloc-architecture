...
mixin _$SignInUseCaseParam {
  ...
  @JsonKey(ignore: true)
  $SignInUseCaseParamCopyWith<SignInUseCaseParam> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SignInUseCaseParamCopyWith<$Res> {
  factory $SignInUseCaseParamCopyWith(
          SignInUseCaseParam value, $Res Function(SignInUseCaseParam) then) =
      _$SignInUseCaseParamCopyWithImpl<$Res, SignInUseCaseParam>;
  @useResult
  $Res call({String email, String password});
}

/// @nodoc
class _$SignInUseCaseParamCopyWithImpl<$Res, $Val extends SignInUseCaseParam>
    implements $SignInUseCaseParamCopyWith<$Res> {
  _$SignInUseCaseParamCopyWithImpl(this._value, this._then);
